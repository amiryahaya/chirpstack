...
[integration]
  ...
  [integration.mqtt]
    ...
    # Share name.
    #
    # This defines the name of the shared subscription. All ChirpStack instances
    # must be configured with the same share_name.
    share_name="{{ integration.mqtt.share_name }}"
