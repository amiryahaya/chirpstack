...
impl FromProto<Revision> for common::RegParamsRevision {
    fn from_proto(self) -> Revision {
        match self {
            ...
            common::RegParamsRevision::Rp002105 => Revision::RP002_1_0_5,
        }
    }
}
...
impl ToProto<common::RegParamsRevision> for Revision {
    fn to_proto(self) -> common::RegParamsRevision {
        match self {
            ...
            Revision::RP002_1_0_4 => common::RegParamsRevision::Rp002104,
            Revision::RP002_1_0_5 | Revision::Latest => common::RegParamsRevision::Rp002105,
        }
    }
}
